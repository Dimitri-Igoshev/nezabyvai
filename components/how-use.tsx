  ...
  return (
    <div className="container mx-auto flex flex-col bg-gray p-[100px] pt-[80px] rounded-2xl mt-[50px]">
      ...
      <div className="flex justify-center items-center group">
        ...
        <div className="flex flex-col bg-primary p-[60px] rounded-[50px] -ml-[140px] pl-[140px] text-white w-2/3">
          <div className="flex gap-7">
            <div className="rounded-full bg-white min-w-[60px] h-[60px] flex items-center justify-center text-primary text-[40px] font-semibold">
              1
            </div>
            <div>
              <h4 className="text-[40px] font-semibold -mt-[10px]">
      ...
      <div className="flex justify-center items-center group -mt-[100px]">
        <div className="flex flex-col bg-primary p-[60px] rounded-[50px] -mr-[140px] pr-[140px] text-white w-2/3">
          <div className="flex gap-7">
            <div className="rounded-full bg-white min-w-[60px] h-[60px] flex items-center justify-center text-primary text-[40px] font-semibold">
              2
            </div>
